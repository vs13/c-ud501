...
def test_run():
	...
	dfreturn.plot(kind='scatter',x='Closeamzn',y='Closegoogl')
	beta_amzn,alpha_amzn = np.polyfit(dfreturn['Closeamzn'],dfreturn['Closegoogl'],1)
	plt.plot(dfreturn['Closeamzn'],beta_amzn*dfreturn['Closeamzn']+alpha_amzn,'-',color='r')
	plt.show()
	print dfreturn.corr(method='pearson')
